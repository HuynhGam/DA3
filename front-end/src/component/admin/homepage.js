                                           ...
                                           users.map(user =>(
                                               <tr key = {user.id}>
                                                   ...
                                                   <td>
                                                       {
                                                           user.VaiTro === 2
                                                           ? <i className="fas fa-check" title='Seller'></i>
                                                           : <i className="fas fa-times" title='User'></i>
                                                       }                                                                                                                            
                                                   </td>
                                                   <td>
                                                       {
                                                           user.VaiTro === 1
                                                           ? <i className="fas fa-check" title='User'></i>
                                                           : <i className="fas fa-times" title='Other'></i>
                                                       }                                                                                                                            
                                                   </td>
                                                   <td>
                                                        <Link to = {`/update-info/${user._id}`}>
                                                            <i className="fas fa-edit" title="Cập nhật thông tin người dùng"></i>
                                                        </Link>               
                                                   </td>
                                               </tr>
                                           ))
